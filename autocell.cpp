...
AutoCell::AutoCell(QWidget *parent) : QWidget(parent) {
    ...
    connect(quitter, SIGNAL(clicked()), this, SLOT(qApp::quit()));
    //couche->addWidget(b_quitter);
...
void AutoCell::launchSimulation() {
    ...
    // il n'est pas nécessaire d'instancier un objet AutomateManager, comme il s'agit d'un singleton,
